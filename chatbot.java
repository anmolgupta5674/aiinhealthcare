			...
			public void actionPerformed(ActionEvent e) {
				...
				if(e.getSource()==b) {                           // Message sents on Click button
					...
					if(text.contains("hi")) {                         // input Checking
						...
						else if(text.contains("i have fever")) {
							replyMeth("Take the medicine having paracetamol:( Eat healthy"+"\n"+"STAY HOME STAY SAFE ");
					}
					else if(text.contains("i have bodypain")) {
						replyMeth("Take paracetamol +acetaminophen (Tylenol) and nonsteroidal anti-inflammatory drugs (NSAIDs) :( Take rest"+"\n"+"STAY HOME STAY SAFE ");
				}
				else if(text.contains("i have  loose motion")) {
					replyMeth("Take Oflox OZ tablet :( Eat healthy"+"\n"+"STAY AT HOME ");
			}
			else if(text.contains("i have  headache")) {
				replyMeth(" the drugs aspirin, ibuprofen (Advil, Motrin IB, others) and naproxen sodium (Aleve).");
		}
	
					else 
						replyMeth("I Can't Understand" +"\n"+ "You can refer here : https://www.google.com/");
